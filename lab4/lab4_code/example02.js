...
function drawScene(gl, deltaTime, programInfo, buffers) {
    ...
    {
        //TODO - Link a vec3 using gl.uniform3fv as the "diffColor" in the shader program
        //the address of the shader uniform variable is obtained with "gl.getUniformLocation"
        gl.uniform3f(programInfo.uniformLocations.diffColor, 0.0, 1.0, 0.0);
...
function intializeShaderProgram(gl) {
    ...
    const fsSource =
        ...
        void main() {
            //TODO: Change the fragColor to output the diffColor uniform
    ...
    const programInfo = {
        ...
        uniformLocations: { 
                diffColor: gl.getUniformLocation(shaderProgram, 'diffColor'),
